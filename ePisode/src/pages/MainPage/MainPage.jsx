  ...
  return (
    <div
      style={{
        ...
        userSelect:
          "none" /* Non-prefixed version, currently supported by Chrome, Firefox, and Opera */,
      }}
    >
      <div className={styles.background} ref={homeRef}>
          ...
          <article className={styles.about1}>
            ...
            <div className={styles.desc}>
              ...
              <p className={styles.explain}>
                당신의 발자취를 지도 위에 표시하고, 글이나 사진을 통해 당신의
                여정을 기록하세요. 모든 에피소드를 한눈에 보며 나만의 이야기를
                완성해 보세요.
              </p>
            </div>
          </article>
          ...
          <article className={styles.about2}>
            <div className={styles.desc2}>
              ...
              <p className={styles.explain2}>
                특별한 순간들을 기록하고, 감성적인 사진으로 당신의 일상을
                아름답게 담아내세요. 다이어리를 통해 소중한 추억들을 한눈에 볼
                때, 각각의 순간들이 어우러져 당신만의 독특한 여정을 만들어내는
                것을 경험할 수 있습니다.
              </p>
            </div>
