...
export const getWeather = async (x, y, date) => {
  ...
  const response = await fetch(
    `${API_BASE_URL}/weather?date=${date}&x=${x}&y=${y}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getMyDiaries = async (offset) => {
  ...
  const response = await fetch(
    `${API_BASE_URL}/diaries/mine?offset=${offset}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getDiaries = async (x, y, offset) => {
  ...
  const response = await fetch(
    `${API_BASE_URL}/diaries?x=${x}&y=${y}&offset=${offset}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const getPublicDiaries = async (x, y, offset) => {
  ...
  const response = await fetch(
    `${API_BASE_URL}/diaries/public?x=${x}&y=${y}&offset=${offset}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
